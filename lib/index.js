...
import { ContentType, HttpHeader, SupportedFeatures } from './constants';
...
export class Kadira {
  ...
  _checkAuth() {
    ...
    return axiosRetry(uri, params, this._options.maxRetries).then(res => {
  ...
  _send(url, params) {
    ...
    }, this._options.maxRetries).then(res => res.data);
  }
}
