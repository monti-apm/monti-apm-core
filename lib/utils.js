...
import { parseStream, stringifyStream } from 'zipson-stream/lib';
...
export const StreamParse = stream => parseStream(stream);
export const StreamStringify = object => stringifyStream(object);
